...
#ifndef  __DocumentHelper_h__
#define  __DocumentHelper_h__
	...
	public:
		...
		*/
		...
		/** Opens a document of the given file name in SnippetRunner's assets folder.
			...
			@param file IN file path and name of the document to be opened.
			@param document OUT handle of the created document.
			@return kNoErr on success, other error code otherwise.
			@see AIDocumentListSuite::Open
		*/
		//ASErr OpenDocument(const ai::UnicodeString& name, AIDocumentHandle& document);
        ASErr OpenDocument(ai::FilePath file, AIDocumentHandle& document);
		...
		*/
		...
		/** Places a file in the current document.
            ...
            @Parar file IN file path and name of file to be placed
		...
		*/
        ...
        ASErr PlaceFile(ai::FilePath& file, AIArtHandle& art);
...
#endif // __DocumentHelper_h__

// End DocumentHelper.h
